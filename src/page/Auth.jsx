  ...
  return (
    <div className="container mx-auto p-6 bg-white rounded">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <button
          type="submit"
          className="mx-auto flex justify-center items-center bg-blue-500 text-white py-2 px-6 rounded-full hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-300  mt-5 "
